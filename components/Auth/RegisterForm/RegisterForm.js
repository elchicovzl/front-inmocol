    ...
    <div className="md:flex w-full">
      ...
      <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
        <div className="text-center mb-10">
          <p>Ingresa tu informacion de registro</p>
        </div>
          ...
          <div className="flex -mx-3">
            <div className="w-full px-3 mb-5">
              <button
                ...
                className="block w-full max-w-xs mx-auto bg-gray-500 hover:bg-gray-600 focus:bg-gray-600 text-white rounded-lg px-3 py-3 font-semibold"
              >
                Iniciar sesion
              </button>
            </div>
...
function validationSchema() {
  return {
    ...
    password: Yup.string()
      ...
      .matches("^(?=.*).{8,}$", "Debe contener min 8 caracteres"),
